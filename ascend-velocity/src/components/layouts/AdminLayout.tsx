...
export const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navItems = [
    ...
    { path: "/admin/communication", label: "Comunicação", icon: Megaphone },
    { path: "/admin/moderation", label: "Moderação", icon: Eye },
    { path: "/admin/access", label: "Controle de Acesso", icon: Shield },
    { path: "/admin/plans", label: "Planos", icon: CreditCard },
    { path: "/admin/billing", label: "Cobrança", icon: CreditCard },
